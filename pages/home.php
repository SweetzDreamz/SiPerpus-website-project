...
<div class="section-card">
    ...
    <div class="content">
        ...
        // yang dimana id kategori selain 4(sejarah)
        // dan ditampilkan secara berurutan dari id buku yang terbaru,
        // dan juga data buku yang ditampilkan hanya 5 data
        $books = $koneksi->query("SELECT * FROM tb_buku JOIN tb_kategori ON tb_kategori.id_kategori=tb_buku.kategori WHERE kategori <> 3 ORDER BY id_buku DESC LIMIT 5 ");
...
<div class="section-card">
    ...
    <div class="content">
        <?php
        $sejarahs = $koneksi->query("SELECT * FROM tb_buku JOIN tb_kategori ON tb_kategori.id_kategori=tb_buku.kategori WHERE kategori=3 LIMIT 5");
        while ($data = $sejarahs->fetch_assoc()) {
            echo '
            <div class="card card-home">
                <img src="assets/book/' . $data['cover'] . '" class="card-img-top" alt="...">
                <div class="card-body">
