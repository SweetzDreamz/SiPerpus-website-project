<nav class="navbar navbar-expand-lg fixed-top">
    <div class="container">
        <a class="navbar-brand" href="?p="><img src="assets/img/siperpus2.png" alt="p" width="55px"></a>
        ...
        <ul class="navbar-nav mb-2 mb-lg-0">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <i class="fa-solid fa-tags icon_kategori " style="color: #ffffff;"></i>
                </a>
        ...
        <div class="d-flex gap-5 user_show">
            ...
            <a href="#" class="text-black showForm">
                <i class="fa-solid fa-magnifying-glass" style="color: #ffffff;" id="iconShowForm"></i>
            </a>
